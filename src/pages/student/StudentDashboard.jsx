    ...
    return (
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-2xl p-12 text-center border border-violet-50 shadow-sm">
          ...
          <p className="text-slate-600 font-semibold mb-2">Akun belum terhubung dengan data siswa</p>
    ...
    <div className="space-y-6">
      ...
      <div>
        <div className="flex items-center justify-between mb-3">
          <h2 className="text-base font-bold text-slate-800">Ekskul Saya</h2>
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-2xl p-8 text-center border border-violet-50 shadow-sm">
            ...
            <p className="text-slate-500 text-sm">Kamu belum terdaftar di ekskul apapun.</p>
          </div>
        ) : (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
