  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-white p-6 rounded-xl border border-slate-100 shadow-sm">
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-slate-900">Penilaian Perkembangan Siswa</h1>
          <p className="text-slate-500 text-sm">Input nilai sikap, keterampilan, dan aktivitas siswa binaan Anda per semester.</p>
        </div>
      ...
      {selectedEkskul ? (
        loading ? (
          <div className="p-8 text-center text-slate-500 font-medium">Memuat data nilai siswa...</div>
        ) : students.length === 0 ? (
                        ...
                        <tr key={student.id} className="hover:bg-slate-50/30 transition-colors">
                          ...
                          <td className="px-4 py-4">
                            <Input
                              ...
                              placeholder="0-100"
                              className="text-center font-mono font-bold text-slate-800"
                            />
                          </td>
                          <td className="px-4 py-4">
                            <Input
