...
export default function ParentAttendance() {
 ...
 <p className="text-sm text-pixel-lavender mt-1">Pantau kehadiran anak di setiap ekstrakurikuler</p>
 </div>
 ...
 {enrollments.length === 0 ? (
 <div className="bg-pixel-panel rounded-none p-12 text-center border border-violet-50 shadow-pixel-sm">
 <p className="text-pixel-lavender">Anak Anda belum terdaftar di ekskul apapun.</p>
 </div>
 ) : (
